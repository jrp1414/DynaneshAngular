...
var ProductListComponent = (function () {
    function ProductListComponent() {
        ...
        this.filterBy = "";
        this.products = [
            new Product_1.Product("Mouse", "GDN-001", 253652.02, "http://viralinfocom.com/wp-content/uploads/2016/08/944242-mouse.jpg", 10.5, 4),
            new Product_1.Product("Keyboard", "GDN-002", 4256.02, "https://codekeyboards.com/galleria/9.jpg", 5.75, 3.5),
            new Product_1.Product("Monitor", "GDN-003", 222.02, "https://pisces.bbystatic.com/image2/BestBuy_US/images/products/5029/5029800_sd.jpg;maxHeight=550;maxWidth=642", 18.25, 2.5),
            new Product_1.Product("Printer", "GDN-004", 7585.02, "http://store.hp.com/wcsstore/hpusstore/Treatment/dsnew-printers-drawer-1-3.jpg", 12.75, 1.5)
        ];
    }
    //products: Product[];
...
//    }
//]; 
//# sourceMappingURL=product_list.component_old.1.js.map